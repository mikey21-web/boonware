    ...
    <>
      <div style={{ position: "fixed", top: 16, left: 0, right: 0, zIndex: 300, display: "flex", justifyContent: "center", padding: "0 16px" }}>
        <div style={{
          ...
          {/* Desktop nav links */}
          <div className="bw-nav-links" style={{ display: "flex", gap: 2, marginLeft: "auto", alignItems: "center" }}>
          ...
          <button onClick={() => setModalOpen(true)} className="bw-cta-btn"
            style={{ background: "#e8643c", color: "#fff", padding: "0 16px", borderRadius: 9999, fontSize: 13, fontWeight: 600, height: 38, display: "inline-flex", alignItems: "center", marginLeft: 4, flexShrink: 0, border: "none", cursor: "pointer", transition: "background 0.2s", whiteSpace: "nowrap", fontFamily: "inherit" }}
