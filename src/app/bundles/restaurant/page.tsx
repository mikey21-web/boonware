...
const keyBenefits = [
  ...
  "Eliminate paper menus and reduce waste",
...
const howItWorks = [
  ...
  "Browses digital menu and places order",
  "Order sent directly to kitchen display",
  "Kitchen prepares food with real-time updates",
  "Customer receives notification when ready",
  "Payment processed through integrated POS",
];

const smartDiningFeatures = [
  "Restaurant Website (Menu, Gallery, Reservations)",
  "POS System with Invoices (GST-ready)",
  "QR Table Scan + Timer",
  "Admin Dashboard (Menu + Orders)",
  "Mobile Responsive Design",
  "🖥️ Desktop App (POS + Admin)",
];

const kitchenSuiteFeatures = [
  "All Smart Dining Features +",
  "Chef Dashboard (Prep Status & Categories)",
  "Kitchen Staff Display (Auto-Refresh, Color Codes)",
  "Real-time Order ETA Countdown",
  "Analytics & Reports (CSV/PDF Export)",
  "🖥️ Desktop App + 📱 Android App (Waiter/Chef)",
];

const featureBadgeClasses =
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-transparent hover:bg-secondary/80 bg-background text-foreground";
...
export default function RestaurantBundlePage() {
  return (
    <PageShell>
      <div className="min-h-screen bg-background">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <div className="flex justify-center mb-6">
                <Utensils className="w-16 h-16 text-primary-light" />
              </div>
              <h1 className="text-4xl lg:text-6xl font-bold text-foreground mb-6">
                Restaurant Automation Bundle
              </h1>
              <div className="w-24 h-1 gradient-border mx-auto mb-6"></div>
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
                Digitize restaurant operations from QR-based ordering to real-time kitchen
                coordination and POS billing.
              </p>
              <div className="text-4xl font-bold text-primary-light mb-8">Starting at ₹54,999</div>
        ...
        <section className="py-20 bg-muted">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto subbundlecard">
              <div className="rounded-lg border text-card-foreground shadow-sm flex hover:shadow-xl text-center bg-card transition-shadow cardsubnamebundle">
                <div className="p-8 hover:shadow-xl transition-shadow">
                  <div className="flex flex-col space-y-1.5 p-6">
                    <div className="flex items-center mb-4">
                      <span className="text-2xl mr-3">🍽️</span>
                      <h3 className="font-semibold tracking-tight text-2xl">Smart Dining Bundle</h3>
                    </div>
                  </div>
                  <div className="p-6 pt-0">
                    <div className="text-4xl font-bold text-primary-light mb-4">₹54,999</div>
                    <ul className="space-y-3 subbundle">
                      {smartDiningFeatures.map((feature) => (
                        <div key={feature} className={featureBadgeClasses}>
              ...
              <div className="rounded-lg border text-card-foreground shadow-sm flex hover:shadow-xl text-center bg-card transition-shadow cardsubnamebundle relative ring-2 ring-primary dark:ring-primary/70">
                  ...
                  <div className="flex flex-col space-y-1.5 p-6">
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="font-semibold tracking-tight text-2xl">
                        Smart Kitchen Intelligence Suite
                      </h3>
                    </div>
                  </div>
                  <div className="p-6 pt-0">
                    <div className="text-4xl font-bold text-primary-light mb-4">₹1,49,999</div>
                    <ul className="space-y-3 subbundle">
                      {kitchenSuiteFeatures.map((feature) => (
                        <div key={feature} className={featureBadgeClasses}>
                          <li className="flex items-start text-foreground justify-start">
                            <Check className="w-5 h-5 text-green-400 mr-3 mt-0.5 flex-shrink-0" />
                            <span>{feature}</span>
        ...
        <section className="py-20 bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-slate-900 dark:to-slate-800">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="text-2xl font-bold text-blue-600 mb-8">Starting at ₹54,999</div>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/appointment" className={primaryButtonClasses}>
